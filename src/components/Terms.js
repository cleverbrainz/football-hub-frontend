  ...
  return (
    <>
      ...
      <p>
        ...
        Indulge Football does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of Indulge Football,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Indulge Football
      ...
      <p>
        Indulge Football reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant Indulge Football a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Indulge Football; and (d) the
      ...
      <p>
        ...
        e-mail to Indulge Football. Please include your name, your organization
      ...
      <p>
        No use of Indulge Football's logo or other artwork will be allowed for
